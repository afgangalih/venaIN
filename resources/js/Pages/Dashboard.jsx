        ...
        <DashboardLayout title="Medical Dashboard">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2 border-b border-slate-200/60">
                <div className="space-y-1">
                    <p className="text-xs font-bold text-primary uppercase tracking-[0.2em] mb-2 leading-none">
                        Diagnostic Center
                    </p>
                    <h1 className="text-4xl font-bold text-slate-900 tracking-tight leading-none">
                        Patient Population{" "}
                        <span className="text-primary/10">|</span> 2026
                    </h1>
                </div>
                <div className="flex items-center gap-2">
                    <Button
                        variant="outline"
                        size="sm"
                        className="hidden sm:flex border-slate-200 hover:bg-white hover:border-slate-300 gap-2 h-10 px-4 rounded-xl shadow-sm text-slate-600"
                    >
                    ...
                    <Button
                        variant="outline"
                        size="sm"
                        className="border-slate-200 hover:bg-white hover:border-slate-300 gap-2 h-10 px-4 rounded-xl shadow-sm text-slate-600"
                    >
                    ...
                    <Button
                        size="sm"
                        className="bg-primary hover:bg-primary/90 text-white h-10 px-8 rounded-xl shadow-lg shadow-primary/20 font-bold tracking-tight"
                    >
                        Generate Report
                    </Button>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                >
                    <div className="flex items-end gap-2 mt-1">
                        ...
                        <span className="text-xs font-bold text-slate-400 mb-1.5 uppercase tracking-wider">
                            %
                        </span>
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                >
                    <div className="flex-1 flex flex-col items-center justify-center p-12 border-2 border-dashed border-slate-100 rounded-2xl bg-slate-50/30 group">
                        <p className="text-slate-400 font-semibold uppercase tracking-widest text-[10px] mb-4">
                        ...
                        <p className="text-slate-500 text-xs max-w-xs text-center leading-relaxed">
                            Prepare your `Recharts` implementation here. Bars
                            and lines will render with{" "}
                    ...
                    <div className="mt-6 flex items-center justify-between pt-6 border-t border-slate-100/60">
                        ...
                        <Link
                            href="#"
                            className="flex items-center gap-1.5 text-xs font-bold text-slate-900 group"
                        >
                ...
                <div className="space-y-6">
                    <Card
                        ...
                        subtitle="Priority review required"
                        className="bg-slate-900 border-none group hover:shadow-[0_20px_50px_rgba(15,23,42,0.15)] overflow-visible relative"
                    >
                        ...
                        <div className="space-y-4 mt-2">
                            {[
                                ...
                                <div
                                    key={i}
                                    className="flex items-center justify-between p-3 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors cursor-pointer group/row"
                                >
                    ...
                    <Card
                        ...
                        className="p-0 border-none bg-transparent shadow-none hover:shadow-none hover:translate-y-0"
                    >
